...
This will create an executable jar file **lab10-microbundle.jar** within the _target_ maven folder. This can be started by executing the following command

    java -jar target/lab10-microbundle.jar
